  ...
  flake.nixosModules.bat = { pkgs, ... }: {
    ...
    home-manager.users.shot = {
      ...
      xdg.configFile."bat/config".text = ''
        # Set the custom base16 theme
        --theme="base16"
      '';

      xdg.configFile."bat/themes/base16.tmTheme".text = /* xml */ ''
            ...
            <array>
              <dict>
                ...
                <dict>
                  ...
                  <key>caret</key>
                  <string>#${c.white1}</string>
                  <key>foreground</key>
                  <string>#${c.white1}</string>
                  <key>invisibles</key>
                  <string>#${c.grey2}</string>
                  <key>lineHighlight</key>
                  <string>#${c.grey2}</string>
                  <key>selection</key>
                  <string>#${c.black2}</string>
                  <key>gutter</key>
                  <string>#${c.black1}</string>
