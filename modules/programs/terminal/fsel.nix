...
in {
  flake.nixosModules.fsel = { pkgs, ...}: {
    ...
    home-manager.users.shot = {
      ...
      xdg.configFile."fsel/config.toml".text = /* toml */ ''
      # ===== BASIC SETTINGS =====
      ...
      main_border_color = "#${c.white}"      # Border color for the main info panel (top)
      apps_border_color = "#${c.white}"      # Border color for the apps list panel (middle)
      input_border_color = "#${c.white}"     # Border color for the input panel (bottom)

      # Text Colors (non-highlighted text in each panel)
      main_text_color = "#${c.white}"        # Text color for the main info panel
      apps_text_color = "#${c.white}"        # Text color for the apps list
      input_text_color = "#${c.white}"       # Text color for the input field

      # Pin/Favorite Settings
      pin_color = "#${c.magenta}"     # Color for pin icon (default: orange)
